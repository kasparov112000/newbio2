...
var CommentsService = /** @class */ (function () {
    ...
    CommentsService.prototype.add = function (slug, payload) {
        return this.apiService
            .post("/blogs/" + slug + "/comments", { comment: { body: payload } }).pipe(operators_1.map(function (data) { return data.comment; }));
    };
    ...
    CommentsService.prototype.destroy = function (commentId, blogSlug) {
        return this.apiService
